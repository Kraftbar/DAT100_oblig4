...
public class LinjeDemo	 extends Application {
	@Override
	public void start(Stage primaryStage) {
		try {
			...
			*/
			...
			// Lager ei linje, som skal være mellom x- og y-koordinatene
			Line linje = new Line(0, 0, 150, 0);
			...
			// Setter at linja skal starte i celle 0,1 og dekke 2 celler horisontalt.
			root.add(linje, 0, 1, 2, 1);
